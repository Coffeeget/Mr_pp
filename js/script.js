$(function () {
    if($('#wrap>div').width() >= 430){floatDiv()}
    ...
    $('#React .projects').find('ul>li.pc:gt(0)').hide();
    var now3 = 0;
    $('#React').each(function () {
        let nBtn3 = $(this).find('.next a');
        let pBtn3 = $(this).find('.prev a');
        nBtn3.click(function () {
            ...
            $('#React .projects').find('ul>li.pc').eq(now3).fadeOut(1000);
            $('#React .projects').find('ul>li.pc').eq(next3).fadeIn(1000);
            now3 = next3;
        });
        pBtn3.click(function () {
            let prev3 = (now3 - 1) % 3;
            ...
            $('#React .projects').find('ul>li.pc').eq(now3).fadeOut(1000);
            $('#React .projects').find('ul>li.pc').eq(prev3).fadeIn(1000);
            now3 = prev3;
        });
    });
    ...
    $('.left a').hover(function(){
        ...
        let imgHeight = $(this).find('img').innerHeight();
